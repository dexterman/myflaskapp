...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:"/ue/upload/images"             //图片上传提交地址
        ...
        //涂鸦图片配置区
        // ,scrawlUrl:"/ue/upload/scrawls"           //涂鸦上传地址
        ...
        ,snapscreenServerUrl: "/ue/upload/images" //屏幕截图的server端保存程序，UEditor的范例代码为“URL +"server/upload/jsp/snapImgUp.jsp"”
        ,snapscreenPath: ""
        ,snapscreenServerPort: location.port                                   //屏幕截图的server端端口
        //,snapscreenImgAlign: ''                                //截图的图片默认的排版方式

        //word转存配置区
        ,wordImageUrl: "ue/upload/images"             //word转存提交地址
        ,wordImagePath: ""                       //
